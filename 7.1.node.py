...
class MyTest(unittest.TestCase):
    def test_empty(self):
        for func in ('merge_ll', 'recursive_merge_ll'):
            first = g[func](from_array([]), from_array([]))
            self.assertEqual(first, None, 'empty')

            first = g[func](from_array([None]), from_array([None]))
